...
def render(st):
    ...
    if st.button("Speichern", key="flight1_save"):
        # Beim Speichern nur die Scores für Flight 1 Spieler aktualisieren
        try:
            # Frische Version erneut laden (um Paralleländerungen nicht zu überschreiben)
            with open(json_path, "r", encoding="utf-8") as f:
            ...
            st.success("Scores für Flight 1 gespeichert.")
        except Exception as e:
